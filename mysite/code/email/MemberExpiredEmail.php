 ...
 */
class MemberExpiredEmail extends Email {
...
<p>
	Your NZLarps membership has expired.
</p>';
	...
	public function __construct($page, $member) {
		...
		$to      = $member->Email;
		$subject = self::get_parsed_string($page->ExpiryEmailSubject, $member, $page);
		$body    = self::get_parsed_string($page->ExpiryEmailTemplate, $member, $page);
