 ...
 */
class MemberReminderEmail extends Email {
	 ...
	 * @var string
	 */
	const DEFAULT_SUBJECT = '$SiteName Membership Reminder';
...
<p>
	Your NZLarps membership is about to expire.
</p>';
	...
	public function __construct($page, $member) {
		...
		$to      = $member->Email;
		$subject = self::get_parsed_string($page->ExpiryReminderEmailSubject, $member, $page);
		$body    = self::get_parsed_string($page->ExpiryReminderEmailTemplate, $member, $page);
